...
export default class Main {
	...
	async render() {
		let body = document.querySelector('body'),
			carouselHolder = body.querySelector('[data-carousel-holder]'),
			ribbonlHolder = body.querySelector('[data-ribbon-holder]'),
			sliderlHolder = body.querySelector('[data-slider-holder]'),
			cartIconlHolder = body.querySelector('[data-cart-icon-holder]'),
			productsGridHolder = body.querySelector('[data-products-grid-holder]');
		...
		let promise = new Promise((resolve) => {
			...
			let natsCheckbox = body.querySelector('#nuts-checkbox'),
				vegetarianCheckbox = body.querySelector('#vegeterian-checkbox');
